...
public class TelaVoto extends javax.swing.JFrame {
    ...
    private void btnVotoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVotoActionPerformed
        ...
        int i = 2015 - a;
        if (i < 16) {
            lblResultado.setText("Nao pode votar por causa de usa idade: "+ i);
        } else if ((i >= 16 && i < 18) || ( i >70)){
            lblResultado.setText("Voto Opcional devido sua idade ser: "+ i);
        } else if (i>70){
                lblResultado.setText("Voto Obrigatório por causa de sua idade ser: "+ i);
        } 
